...
class _$AnswerModelTearOff {
  ...
  _AnswerModel call({required String id, required String answer}) {
    return _AnswerModel(
      id: id,
      answer: answer,
    );
...
class _$_AnswerModel implements _AnswerModel {
  const _$_AnswerModel({required this.id, required this.answer});
...
abstract class _AnswerModel implements AnswerModel {
  const factory _AnswerModel({required String id, required String answer}) =
      _$_AnswerModel;
